...
By default, ggplot suggests a bin count; it also warns when it omits missing values. Specify bins or binwidth deliberately, and check whether missing values need separate treatment.
