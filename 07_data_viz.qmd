...
A useful package for creating scientific plots is `{ggpubr}`. The function `theme_pubr` is especially useful to create plots with most of the modifications required for publication quality plots.
